...
export default function Home_new() {
  ...
  return (
    <>
      <div
        id='cursor'
        class='h-[40px] w-[40px] rounded-full z-[100] fixed top-0 left-0 pointer-events-none overflow-hidden'>
        <img
      ...
      <div id='main' class='w-full min-h-screen bg-[rgb(12, 19, 78)]'>
        {/* Header */}
        {/* Hero Section */}
        <section class='w-full px-8 py-20 relative overflow-hidden'>
            ...
            <div class='bg-indigo-50 rounded-3xl p-12'>
              ...
              <div class='text-center space-y-4 mb-16'>
                ...
                <p class='text-lg text-neutral-700 font-normal font-inter leading-relaxed tracking-wide max-w-3xl mx-auto'>
                  ...
                  project, take part in coding contests and have guidance from
                  AI agents
                </p>
              </div>
